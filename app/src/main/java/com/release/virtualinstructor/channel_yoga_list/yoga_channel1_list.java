...
public class yoga_channel1_list extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yoga_channel1_list);

        // on clicking back button
        ImageView back = findViewById(R.id.yoga_channel1_back);
        ...
        CardView yoga1 = findViewById(R.id.channel1_yoga1);
        TextView text1 = findViewById(R.id.yoga1_text);

        CardView yoga2 = findViewById(R.id.channel1_yoga2);
        TextView text2 = findViewById(R.id.yoga2_text);

        CardView yoga3 = findViewById(R.id.channel1_yoga3);
        TextView text3 = findViewById(R.id.yoga3_text);

        CardView yoga4 = findViewById(R.id.channel1_yoga4);
        TextView text4 = findViewById(R.id.yoga4_text);

        CardView yoga5 = findViewById(R.id.channel1_yoga5);
        TextView text5 = findViewById(R.id.yoga5_text);

        CardView yoga6 = findViewById(R.id.channel1_yoga6);
        TextView text6 = findViewById(R.id.yoga6_text);

        CardView yoga7 = findViewById(R.id.channel1_yoga7);
        TextView text7 = findViewById(R.id.yoga7_text);

        CardView yoga8 = findViewById(R.id.channel1_yoga8);
        TextView text8 = findViewById(R.id.yoga8_text);

        CardView yoga9 = findViewById(R.id.channel1_yoga9);
